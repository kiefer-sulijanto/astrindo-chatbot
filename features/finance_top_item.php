...
function handleFinanceTopItem($conn, $entities) {
    ...
    if ($month && $year) {
        $title = "📦 Most Requested Finance Items $monthName $year:\n\n";
    } elseif ($year) {
        $title = "📦 Most Requested Finance Items in $year:\n\n";
    } else {
        $title = "📦 Most Requested Finance Items:\n\n";
    }
    ...
    if ($result->num_rows > 0) {
        ...
        $response = "❌ No data found for Finance items.";
    }
